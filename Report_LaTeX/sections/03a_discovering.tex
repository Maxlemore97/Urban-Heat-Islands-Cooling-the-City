...
The biologized questions were also used to search for solutions using search
engines such as Google.

Selected models had to fulfill at least one function listed in Section~\ref{sec:functions} while also fitting into at least one of the defined Life's Principles.
Therefore some models were abandoned and not investigated further.
...
\runin{Biological mechanism.}
In addition to their ears, African elephants have a second cooling mechanism. They have
